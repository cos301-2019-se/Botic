...
Our system is an interactive system. We will be using a 3-tier architectural style for the first level of granularity as a result. This architectural style is in line with making sure that the entire system has prioritizes availability. The first layer, follwos the MVC architecture-- that is how the Angular framework works. The rest of the system consists of an AI layer, as well as Database or Persistance layer.
