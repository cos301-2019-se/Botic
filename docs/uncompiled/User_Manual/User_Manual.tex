...
\begin{flushleft}
	...
	\includegraphics[width=1.0\textwidth]{UsersButton.png}
	...
	\includegraphics[width=1.0\textwidth]{UserID.png}
	Next, click on "Rules" in the left menu panel.
	\includegraphics[width=1.0\textwidth]{RulesButton.png}
	Click on the edit icon of the "Redirect Logins" Rule.
	\includegraphics[width=1.0\textwidth]{RulesPage.png}
	...
	\includegraphics[width=1.0\textwidth]{AddAdmin.png}
	Click on "Save" to complete the addition of the new administrator.
	\includegraphics[width=1.0\textwidth]{Save.png}
